package net.doge.constant.core.ui;
...
public class Fonts {
    ...
    public static final String[] NAMES = {"鸿蒙", "小米", "苹方", "像素"};
    private static final String[] FONT_NAMES = {"HarmonyOS_Sans_SC_Medium", "MiSans-Demibold", "PingFang_SC", "fusion-pixel-12px-monospaced-zh_hans"};
